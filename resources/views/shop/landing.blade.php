...
<body class="bg-zinc-50">
            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('shop.index') }}"
                        class="inline-flex items-center gap-2 px-8 py-3 bg-stone-800 text-white rounded-full font-semibold hover:bg-[#D65A48] transition-all hover-lift">
                        <i data-lucide="shopping-bag" class="w-5 h-5"></i>
                        Start Shopping
                    </a>
                    <a href="#features"
                        class="inline-flex items-center gap-2 px-8 py-3 bg-transparent border-2 border-stone-800 text-stone-800 rounded-full font-semibold hover:bg-stone-800 hover:text-white transition-all">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                ...
                <a href="{{ route('shop.index', ['category' => 2]) }}" class="group">
                    <div
                        class="category-card bg-gradient-to-br from-pink-100 to-pink-200 rounded-lg p-6 text-center h-32 flex flex-col items-center justify-center">
                        <i data-lucide="shirt" class="w-10 h-10 text-pink-700 mb-3"></i>
                        <h3 class="font-semibold text-pink-900">Tops</h3>
                    </div>
                </a>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-12">
                ...
                <a href="{{ route('shop.index') }}"
                    class="flex items-center gap-2 text-purple-700 hover:text-purple-800 font-medium">
                    View All
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                @foreach($featuredProducts ?? App\Models\Product::inRandomOrder()->take(10)->get() as $product)
                    <a href="{{ route('shop.product', $product->id) }}" class="group">
                        <div
                            class="relative aspect-[3/4] overflow-hidden rounded-lg border border-zinc-200 bg-zinc-100 mb-3 hover-lift">
                            <img src="{{ $product->images[0] ?? 'https://via.placeholder.com/400' }}"
                                alt="{{ $product->name }}"
                                class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110">
                            <div
                                class="absolute top-2 left-2 px-2 py-1 text-[9px] font-medium rounded backdrop-blur bg-white/90 text-zinc-900">
                                {{ ucfirst($product->condition) }}
                            </div>
                            @if($product->featured)
                                <div
                                    class="absolute top-2 right-2 px-2 py-1 text-[9px] font-medium rounded backdrop-blur bg-gradient-to-r from-yellow-400 to-orange-500 text-white">
                        ...
                        <h3
                            class="text-sm font-medium text-zinc-900 group-hover:text-purple-600 transition-colors line-clamp-2">
                            {{ $product->name }}
                        </h3>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4" id="faq-container">
                ...
                <div class="faq-item border border-zinc-200 rounded-lg overflow-hidden">
                    <button
                        class="faq-button w-full px-6 py-4 flex items-center justify-between bg-zinc-50 hover:bg-zinc-100 transition-colors text-left">
                        <span class="font-semibold text-zinc-900">What is D4ily and how does it work?</span>
                        <i data-lucide="chevron-down"
                            class="w-5 h-5 text-zinc-500 transition-transform duration-300"></i>
                    </button>
                    <div class="faq-content hidden px-6 py-4 bg-white">
                        <p class="text-zinc-600">
                            D4ily is a vintage thrift shop dedicated to sustainable fashion. We curate and sell
                            pre-loved clothing, bags, accessories, and jewelry. Each item is carefully inspected for
                            quality and authenticity, giving vintage pieces a new life while reducing fashion waste.
                        </p>
                    </div>
                </div>
                ...
                <div class="faq-item border border-zinc-200 rounded-lg overflow-hidden">
                    ...
                    <div class="faq-content hidden px-6 py-4 bg-white">
                        <p class="text-zinc-600">
                            Each item is thoroughly inspected and rated on condition: Excellent (like new), Great
                            (minimal signs of wear), Good (normal wear consistent with age), or Fair (notable wear but
                            still wearable). We always provide detailed photos and accurate descriptions so you know
                ...
                <div class="faq-item border border-zinc-200 rounded-lg overflow-hidden">
                    ...
                    <div class="faq-content hidden px-6 py-4 bg-white">
                        <p class="text-zinc-600">
                            We accept all major credit and debit cards, online banking transfers, and e-wallets
                            including GrabPay and Touch 'n Go. All payments are securely processed through our trusted
                            payment gateway.
                        </p>
                    </div>
                </div>
                ...
                <div class="faq-item border border-zinc-200 rounded-lg overflow-hidden">
                    ...
                    <div class="faq-content hidden px-6 py-4 bg-white">
                        <p class="text-zinc-600">
                            Due to the unique nature of vintage items, all sales are final. However, if an item arrives
                            significantly different from its description or is damaged, please contact us within 48
                            hours of delivery and we'll work to make it right.
                        </p>
                    </div>
                </div>
                ...
                <div class="faq-item border border-zinc-200 rounded-lg overflow-hidden">
                    ...
                    <div class="faq-content hidden px-6 py-4 bg-white">
                        <p class="text-zinc-600">
                            We ship nationwide using reliable courier services. Orders are typically processed within
                            1-2 business days, with delivery taking 2-5 business days depending on your location. You'll
                ...
                <div class="faq-item border border-zinc-200 rounded-lg overflow-hidden">
                    ...
                    <div class="faq-content hidden px-6 py-4 bg-white">
                        <p class="text-zinc-600">
                            Shopping vintage extends the lifecycle of clothing, reducing the demand for new production
                            and keeping items out of landfills. The fashion industry is one of the world's largest
                            polluters, and by choosing pre-loved pieces, you're helping reduce water waste, carbon
    ...
    <!-- CTA Section -->
    <section class="relative py-16 text-stone-800" style="
    background-color: #CBBFA2;
    background-image: repeating-linear-gradient(
      90deg,
      #a1b26c 0px,
  ...
  ">
        <div class="relative z-10">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl sm:text-4xl font-bold mb-6" style="color: #D65A48;">Ready to Find Your Vintage
                    Treasure?</h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    @guest
                        <a href="{{ route('register') }}"
                            class="inline-flex items-center gap-2 px-8 py-3 bg-stone-800 text-white rounded-full font-semibold hover:bg-[#D65A48] transition-all">
